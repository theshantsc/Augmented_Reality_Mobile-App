  ...
  //  };
    ...
    protected void InitializeFirebase() {
     ...
     /* if (otherAuthOptions != null &&
	  ...
	  DebugLog("Firebase intialization done!");
    }
	...
	public void CreateUserWithEmailAsync() {
	  ...
	  DebugLog(String.Format("Attempting to create user {0}...", newDisplayName));
    ...
    public Task UpdateUserProfileAsync(string newDisplayName = null) {
      ...
      //  EnableUI();
       ...
       // }
	  DebugLog(String.Format("Running Transaction... userId:", userId));
    ...
    public void SigninWithEmailAsync() {
     ...
     // } else {
	    DebugLog("SignInWithEmailAndPasswordAsync");
    ...
    public Task SigninWithEmailCredentialAsync() {
      ...
      if (signInAndFetchProfile) {
        ...
        return auth.SignInWithCredentialAsync(
          Firebase.Auth.EmailAuthProvider.GetCredential(email, password)).ContinueWith(
            HandleSignInWithUser2);
      }
    }


      void HandleSignInWithUser2(Task<Firebase.Auth.FirebaseUser> authTask) {
    ...
    void HandleSignInWithUser(Task<Firebase.Auth.FirebaseUser> task) {
     ...
     EnableUI();
      if (LogTaskCompletion(task, "Sign-in")) {
	    DebugLog(String.Format("{0} HandleSignInWithUser signed in", task.Result.DisplayName));
      }  
    ...
    void HandleSignInWithSignInResult(Task<Firebase.Auth.SignInResult> task) {
      ...
      if (LogTaskCompletion(task, "Sign-in")) {
        ...
        DisplaySignInResult(task.Result, 1);
	      ...
	      DebugLog("HandleSignInWithSignInResult");
      }
    }
    ...
    protected void SignOut() {
      ...
      List<object> leaders = mutableData.Value as List<object>;
	      DebugLog(String.Format("AddScoreTransaction userId:", userId));
